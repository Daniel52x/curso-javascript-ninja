(function(){      
    ...
    */
    ...
    function formatarCPF( cpf ){
        ...
        return cpf.replace(regex, function( searc, arg1, arg2, arg3, arg4){
           return arg1 + '.' + arg2 + '.' + arg3 + '-' + arg4;
        });
    }
    console.log( formatarCPF( cleanCPF('049-214 3421-1') ) );
    console.log( formatarCPF( cleanCPF('735 500 794 - 22') ) );
    /*
    ...
    */
    ...
    var meses = 'Os meses de janeiro, junho e julho começam com a letra j.';
    console.log( meses.match(/(ju[nl]ho)/g) );
    ...
    */
    ...
    console.log( textHtml.match(/<\w+\>/g) );
