(function(){
    ...
    */
    console.log( '\nOperation:' );
    var operation = 1 + justMod2Or3.reduce(function(acumulador, item){
    ...
    */
    console.log( '\nOperation 2:' );
    var operation2 = 1 + justMod2Or3.reduceRight(function(acumulador, item){
        return acumulador * item;
    }, 0);
    ...
    */
    ...
    var nome = ['Da', 'ni', 'el'];
    var nomeP = nome.reduce(function(acumulador,item){
    ...
    */
    console.log( '\nInversed Name:' );
    var inversedName = nome.reduceRight(function(acumulador, item){
        return acumulador + item;
    });
