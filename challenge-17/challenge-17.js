(function(){
    ...
    */
    ...
    console.log( text.replace(/Manuel Marques de Sousa/, 'Daniel Costa') );
    ...
    */
    ...
    console.log( text.replace(/O Centauro de Luvas/, function(centauro){
        return (centauro).toUpperCase();
    }))
    ...
    */
    ...
    console.log( text.replace(regexDate, function(search, day, mount, year){
        return day + '/' + getMonthNumber(mount) + '/' + year;
    }))
