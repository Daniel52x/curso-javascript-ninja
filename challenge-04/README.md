...
carro.addPessoas = function (qtdPessoas){
    if(carro.quantidadePessoas >= carro.assentos){
        ...
        var qtdAssentosLivres = carro.assentos - carro.quantidadePessoas;
        var finalFrase = qtdAssentosLivres === 1 ? 'pessoa' : 'pessoas';
        return "Só cabem mais " + qtdAssentosLivres + " " + finalFrase;
    }
...
carro.obterMarcaModelo(); //Esse carro é um Wolks Gol
...
carro.addPessoas(-4); // O carro já está lotado!
