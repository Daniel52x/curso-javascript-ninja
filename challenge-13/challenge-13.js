(function(){
    ...
    */
    var newSudeste = [];
    newSudeste = brasil.filter(function(item, index){
        return sudeste.indexOf(item) >= 0;
    });
    // console.log(brasil);
    // console.log('-----------');
    /*
    ...
    */
    ...
    var maisSete = brasil.every(function(item){
    ...
    */
    ...
    var indCeara = brasil.some(function(item){
        return item === 'CE';
    });
    if(indCeara){
